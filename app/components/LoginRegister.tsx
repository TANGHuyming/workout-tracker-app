...
export default function LoginRegister({
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        setToast({ message: "Failed to send reset email", type: "error" });
        return;
      }
  ...
  if (showRegister) {
    return (
      <div className={`${formHeaderStyle}`}>
        <div className="bg-linear-to-r from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 p-6 border-b border-slate-200 dark:border-slate-800">
      ...
      <div className={`${formHeaderStyle}`}>
        ...
        <div className="p-6">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center gap-2"
          >
            Send Reset Link
          </button>
        </div>
